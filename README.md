...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/santhoshyarramsetty/Chatbot-Using-Langchain.git
     ```
...
Santhosh Yarramsetty - (2200032905cser@gmail.com)
